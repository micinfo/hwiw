  ...
  return (
    <section className="relative min-h-screen bg-amber-100 pb-12">
      ...
      <div className="container mx-auto px-4 pt-16 pb-24">
        <h1 className="text-5xl font-bold text-white text-center mb-16">Video Resources</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          <div className="space-y-6 grid grid-cols-2 gap-4">
            ...
            <div className="bg-pink-200 rounded-lg overflow-hidden shadow-lg transform transition-transform hover:scale-105">
              ...
              <div className="p-4">
                <div className="uppercase text-xs font-bold text-purple-700 mb-1">HYPERTENSION</div>
                <h3 className="text-lg font-bold text-purple-900 mb-2">Sodium Alert: What Office Snacks You Should Watch Out For Pressure in 10 Minutes</h3>
            ...
            <div className="bg-cyan-100 rounded-lg overflow-hidden shadow-lg transform transition-transform hover:scale-105">
              ...
              <div className="p-4">
                <div className="uppercase text-xs font-bold text-teal-700 mb-1">DIABETES</div>
                <h3 className="text-lg font-bold text-teal-800 mb-2">Understanding Gestational Diabetes as a Working Mom</h3>
                <div className="flex justify-between text-xs text-gray-600">
            ...
            <div className="bg-purple-200 rounded-lg overflow-hidden shadow-lg transform transition-transform hover:scale-105">
              ...
              <div className="p-4">
                <div className="uppercase text-xs font-bold text-purple-700 mb-1">THYROID</div>
                <h3 className="text-lg font-bold text-purple-900 mb-2">Managing Thyroid Symptoms During Your Workday</h3>
                <div className="flex justify-between text-xs text-gray-600">
            ...
            <div className="bg-pink-200 rounded-lg overflow-hidden shadow-lg transform transition-transform hover:scale-105">
              ...
              <div className="p-4">
                <div className="uppercase text-xs font-bold text-purple-700 mb-1">HYPERTENSION</div>
                <h3 className="text-lg font-bold text-purple-900 mb-2">Monitoring Blood Pressure at Home: A Complete Guide</h3>
                <div className="flex justify-between text-xs text-gray-600">
